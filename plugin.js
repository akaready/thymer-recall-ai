...
${transcriptText}`
    ...
    _stripInlineButtons() {
      document.querySelectorAll(`.${INLINE_BUTTON_CLASS}`).forEach((el) => el.remove());
      document.querySelectorAll(`[${INLINE_APPLIED_ATTR}]`).forEach((el) => el.removeAttribute(INLINE_APPLIED_ATTR));
    }
    _renderPanel() {
